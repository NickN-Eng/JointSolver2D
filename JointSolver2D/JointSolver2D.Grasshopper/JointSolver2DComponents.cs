...
{
    public class CreateNode_Component : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public CreateNode_Component()
          : base("Create JSNode", "JSNode",
              "Construct a JointSolver Node.",
              "Elements", "")
        {
        }
        ...
        {
            get { return new Guid("1083d3ba-c6e4-43de-abbc-dbdf04db36a0"); }
        }
    }
}
